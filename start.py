...
def banner():
    print(f'''
                    ...
                    {white}      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@                         
                    {white}    @@@@@@@   @@@@@@@@@@@@@@@@@@@@@@@                       
                       @@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@@& {cyan}| Telegram :: @sasta396{white}           
                       @@@@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@ {green}| Github :: @Wishu693{white}   
                      .@@@@@@@@@@@@@*  &@@@@@@@@@@@@@@@@@@ {red}| Youtube :: @Impossibl_ideas{white}     
...
def update():
    ...
    git_ver = str(
        requests.get(
            "https://github.com/Wishu693/Termux_HackingLab_Setup/main/.version"
        ).text
    ).split()
    if version == git_ver[0]:
        ...
        changelog = requests.get(
            "https://github.com/Wishu693/Termux_HackingLab_Setup/main/.changelog.log"
        ).text
        update_commands = requests.get(
            "https://github.com/Wishu693/Termux_HackingLab_Setup/main/.update"
        ).text
        system("clear")
        banner()
        print(
